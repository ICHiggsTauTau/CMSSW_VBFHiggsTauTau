...
SAMPLE="VBF_HToTauTau_EleHad_METEtaRange5p0"
...
vbftautau_runTriggerAnalysis --doAnalysisL1TAlgoScan --doAnalysisL1TResolution --input ${REMOTEDIR}/L1Ntuple_${SGE_TASK_ID}.root --outputFilename results_${SGE_TASK_ID}.root --maxEvents -1 --jobType mc --decay EleHad
