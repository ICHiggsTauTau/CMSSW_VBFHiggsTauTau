...
namespace L1Analysis
{
  ...
  struct L1AnalysisL1UpgradeDataFormat
  {
    ...
    std::vector<float>     egEnergy; // JP Added to match P4 definition;
    ...
    std::vector<float>     tauEnergy; // JP Added to match P4 definition;
    ...
    std::vector<float>     jetEnergy; // JP Added to match P4 definition;
    ...
    std::vector<float>              muonEnergy; // JP Added to match P4 definition;
